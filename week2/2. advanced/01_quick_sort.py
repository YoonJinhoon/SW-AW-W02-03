...
def partition(arr, low, high):
    ...
    Returns: 피벗의 최종 위치 인덱스
    """
    # 피벗을 선택 (일반적으로 마지막 원소를 선택) (Lamuto partition algorithm)
    pivot = arr[high]
    
    # 포인터 2개 초기화 (i, j)
        # i 는 -1 부터 시작
        # j 는 low 부터 시작, 피벗과 비교할 때 필요한 인덱스

    # 피벗보다 작은 원소들의 마지막 인덱스를 추적하는 변수 i
    i = low - 1
